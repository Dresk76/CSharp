...
{
    public class Employee(int id, string name, string lastName, string identification,
    string jobTitle, decimal baseSalary, int workedDays, Overtime overtime, decimal holidayDaysWorked)
    {
    ...
    public struct Overtime(decimal dayHours, decimal nightHours, decimal holidayDayHours, decimal holidayNightHours)
    {
